...
Forklift use mainly the BonitaStore library. So, a change in forklift may implie a change in the BonitaStore library. Do the change in the library and give the same title. 
Attention, you must increase the BonitaStore version, and reference the new version in the forklift/pom.xml
